...
async function getAlloyInstance(permalink: Permalink, cmd: number) {
    let url = `/alloy/alloycnd/instance?check=${permalink.check}&p=${permalink.permalink}&cmd=${cmd}`;
    try {
...
export const executeAlloyCnDTool = async () => {
    ...
    try {
        ...
        console.log('AlloyCnD Instance:', res);
